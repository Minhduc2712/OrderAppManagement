...
import {
  actionFetchProductByCategoryId,
...
const FoodDetails = () => {
  ...
  const { dataByCategoryId: productByCategory } = useSelector(
    selectProductByCategoryId
  );
  ...
  const { name, price, categoryName, desc } = product;
  ...
  useEffect(() => {
    const fetchProductsByCategory = async () => {
      if (selectedCategoryId) {
        await dispatch(actionFetchProductByCategoryId(selectedCategoryId));
      }
    };
